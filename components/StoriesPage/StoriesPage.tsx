...
import CategoriesMenu from '../Category/Category';
import Loader from '../Loader/Loader';
import {fetchStories, fetchSavedStoriesByUserId} from '../../lib/api/api';
...
//     const savedIds: string[] = isAuthenticated ? savedStories?.map(story=>story._id)  : [];
...
//                 const nextPage=page + 1;
//                 const categoryParam=categoryId === 'all' ? undefined : categoryId;
//                 const newStories=await fetchStories(PER_PAGE,  nextPage,  categoryParam);
//                 setStories(prev=>[...prev, ...newStories]);
//                 if(newStories.length > FIRST_LOAD){
//                     setHasMore(false);
//                 } else {
